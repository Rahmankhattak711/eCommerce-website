...
export default function SubscribeSection() {
  return (
    <section className="relative z-0 h-screen overflow-x-clip ">
      <div className="absolute inset-0 -z-50 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] ">
